...
`,Ae=12e4,Oe=3e5,E=null,Ne=0,b=new Map,L=new Set;function Pe(a){return L.add(a),()=>L.delete(a)}function Ie(a){for(const d of L)d(a)}function Ce(){return"./pyodide/pyodide-worker.js"}function Ge(){const a=new Worker(Ce()),d=new Promise((m,_)=>{let p,w=!1;const u=y=>{if(!w){w=!0,p&&clearTimeout(p),a.terminate(),E=null;for(const[c,g]of b)b.delete(c),g.reject(new Error(y))}};p=setTimeout(()=>{const y="Timed out loading the Python runtime. Check your connection and try again.";u(y),_(new Error(y))},Ae),a.onmessage=y=>{const c=y.data??{};switch(c.type){case"progress":Ie(c.phase);break;case"ready":p&&clearTimeout(p),m();break;case"result":{const g=b.get(c.id);g&&(b.delete(c.id),g.resolve({geojson:c.geojson,messages:c.messages}));break}case"error":{const g=c.message||"Pyodide error";if(c.id===void 0)u(g),_(new Error(g));else{const S=b.get(c.id);S&&(b.delete(c.id),S.reject(new Error(g)))}break}}},a.onerror=y=>{const c=y.message||"Pyodide worker failed";u(c),_(new Error(c))}});return a.postMessage({type:"init",indexURL:ke(),vectorOpsSource:Te}),d.then(()=>({worker:a}))}function Re(){return E??=Ge().catch(a=>{throw E=null,a}),E}async function Ve(a){const{worker:d}=await Re(),m=Ne++;return new Promise((_,p)=>{const w=setTimeout(()=>{if(b.has(m)){b.delete(m),d.terminate(),E=null;for(const[u,y]of b)b.delete(u),y.reject(new Error("Pyodide worker was reset after a timeout."));p(new Error("The Python (Pyodide) operation timed out."))}},Oe);b.set(m,{resolve:u=>{clearTimeout(w),_(u)},reject:u=>{clearTimeout(w),p(u)}}),d.postMessage({type:"run",id:m,request:a})})}var o=K(re(),1),r=K(fe(),1);function Me(){const a=[];for(const d of M){const m=d.group??"Tools";let _=a.find(p=>p.group===m);_||(_={group:m,tools:[]},a.push(_)),_.tools.push(d)}return a}function Le({mapControllerRef:a}){const{t:d}=he(),m=k(e=>e.ui.vectorToolOpen),_=k(e=>e.setVectorToolOpen),p=k(e=>e.layers),w=k(e=>e.addGeoJsonLayer),u=k(e=>e.ui.processingRerun),y=k(e=>e.setProcessingRerun),c=m!==null,[g,S]=(0,o.useState)(m??M[0].id),[i,T]=(0,o.useState)({}),[x,A]=(0,o.useState)("client"),[P,O]=(0,o.useState)([]),[D,q]=(0,o.useState)(!1),[I,F]=(0,o.useState)(null),[U,J]=(0,o.useState)(!1),W=(0,o.useRef)(null),B=(0,o.useRef)(null),s=(0,o.useMemo)(()=>Y(g)??M[0],[g]),H=(0,o.useMemo)(()=>Se(),[]);(0,o.useEffect)(()=>{m&&S(m)},[m]),(0,o.useEffect)(()=>{const e={};for(const n of s.parameters)n.default!==void 0&&(e[n.id]=n.default);T(e),O([]),s.requiresSidecar?A("sidecar"):s.supportsSidecar||A("client")},[s]),(0,o.useEffect)(()=>{if(!c||!u||u.kind!=="vector")return;const e=xe(u.toolId,u.parameters);if(!Y(e.toolId)){O(n=>[...n,`Error: ${d("processing.history.toolUnavailable",{toolId:u.toolId})}`]),y(null);return}if(e.toolId!==s.id){g!==e.toolId&&S(e.toolId);return}T({...e.parameters}),(u.engine==="client"||u.engine==="sidecar"||u.engine==="pyodide")&&A((u.engine,u.engine)),y(null),u.autoRun&&J(!0)},[c,u,s,g,y,d]),(0,o.useEffect)(()=>{if(g!=="dggs-grid"||i.source!=="bbox"||i.west!==void 0||i.south!==void 0||i.east!==void 0||i.north!==void 0)return;const e=a.current?.getMap();if(!e)return;const n=e.getBounds(),t=l=>Number(l.toFixed(6));T(l=>({...l,west:t(n.getWest()),south:t(n.getSouth()),east:t(n.getEast()),north:t(n.getNorth())}))},[g,i.source,a]),(0,o.useEffect)(()=>{if(!c)return;let e=!1;return be().then(n=>{e||F(n.available)}).catch(()=>{e||F(!1)}),()=>{e=!0}},[c]),(0,o.useEffect)(()=>{W.current?.scrollIntoView({block:"end"})},[P]);const C=(0,o.useRef)(null),h=(0,o.useCallback)(e=>{e.startsWith("Error:")&&(C.current=e.slice(6).trim()),O(n=>[...n,e])},[]),Z=(0,o.useCallback)(e=>p.filter(n=>{if(n.type!=="geojson"||!n.geojson)return!1;if(!e?.length)return!0;const t=_e(n.geojson);return e.some(l=>l==="point"&&t.hasPoint||l==="line"&&t.hasLine||l==="polygon"&&t.hasPolygon)}),[p]),z=(0,o.useMemo)(()=>{const n=new Map;if(!c)return n;for(const t of p){if(t.type!=="geojson"||!t.geojson)continue;const l=new Set;for(const f of t.geojson.features.slice(0,1e3))for(const j of Object.keys(f.properties??{}))l.add(j);n.set(t.id,[...l])}return n},[p,c]),ee=(0,o.useCallback)(e=>{const n=i[e.fieldSource??"layer"];return n&&z.get(n)||[]},[z,i]),ne=(0,o.useCallback)((e,n)=>{T(t=>{const l={...t,[e]:n};for(const f of s.parameters)f.type==="field"&&(f.fieldSource??"layer")===e&&(l[f.id]=void 0);return l})},[s]),G=(0,o.useCallback)(e=>{const n=e.visibleWhen;if(!n)return!0;const t=i[n.param];return"in"in n?t!=null&&n.in.includes(t):t==null||!n.notIn.includes(t)},[i]),N=(0,o.useCallback)((e,n)=>{if(!n.features.length){h(`No features produced for "${e}"`);return}const t=w(e,n);B.current?.addOutputLayer(e);const l=k.getState().layers.find(f=>f.id===t);l&&a.current?.fitLayer(l)},[w,h,a]),R=(0,o.useCallback)(async(e,n)=>{const t=p.find(v=>v.id===i.layer),l=p.find(v=>v.id===i.overlay);if(!t?.geojson){const v="input layer no longer exists in the project";return h(`Error: ${v}`),v}if(i.overlay&&!l?.geojson){const v="overlay layer no longer exists in the project";return h(`Error: ${v}`),v}h(`Running "${s.name}" ${e}...`);const f=await n({tool_id:s.id,geojson:t.geojson,overlay:l?.geojson,parameters:i});for(const v of f.messages)h(v);const j=f.geojson;if(j?.type==="FeatureCollection"&&Array.isArray(j.features))return N(s.name,j),null;const X="engine returned invalid GeoJSON";return h(`Error: ${X}`),X},[p,i,s,h,N]),V=(0,o.useCallback)(async()=>{O([]),C.current=null;for(const n of s.parameters){if(!n.required||!G(n))continue;const t=i[n.id];if(t===void 0||t===""||t===null||n.type==="number"&&Number.isNaN(t)){h(`Error: "${n.label}" is required`);return}}const e=we({kind:"vector",toolId:s.id,toolName:s.name,engine:x,parameters:i});B.current=e,q(!0);try{let n=null;if(x==="sidecar")n=await R("on the Python sidecar",je);else if(x==="pyodide"){const l=Pe(f=>h(`${f}...`));try{n=await R("in your browser (Pyodide)",Ve)}finally{l()}}else{const l={layers:p,parameters:i,log:h,fitBounds:f=>a.current?.fitBounds(f),addResultLayer:N,duckdb:H,viewportBounds:()=>{const f=a.current?.getMap();if(!f)return null;const j=f.getBounds();return[j.getWest(),j.getSouth(),j.getEast(),j.getNorth()]}};await s.run(l)}const t=n??C.current;t?e.finish("error",t):e.finish("success")}catch(n){h(`Error: ${n.message}`),e.finish("error",n.message)}finally{q(!1)}},[s,i,x,p,h,N,R,a,G,H]),$=(0,o.useRef)(V);(0,o.useEffect)(()=>{$.current=V}),(0,o.useEffect)(()=>{U&&(J(!1),$.current())},[U]);const te=(0,o.useMemo)(Me,[]);return(0,r.jsx)(ue,{open:c,onOpenChange:e=>{e||_(null)},children:(0,r.jsxs)(ce,{className:"max-w-3xl",children:[(0,r.jsxs)(le,{children:[(0,r.jsx)(pe,{children:d("processing.vectorTools.title")}),(0,r.jsx)(de,{children:d("processing.vectorTools.description")})]}),(0,r.jsxs)("div",{className:"flex gap-4",children:[(0,r.jsx)(Q,{className:"h-[22rem] w-48 shrink-0 rounded-md border",children:(0,r.jsx)("div",{className:"p-1",children:te.map(e=>(0,r.jsxs)("div",{className:"mb-1",children:[(0,r.jsx)("div",{className:"px-2 py-1 text-xs font-medium text-muted-foreground",children:e.group}),e.tools.map(n=>(0,r.jsx)("button",{type:"button",onClick:()=>S(n.id),className:oe("w-full rounded-md px-2 py-1.5 text-start text-sm transition-colors hover:bg-accent",n.id===g&&"bg-accent font-medium text-accent-foreground"),children:n.name},n.id))]},e.group))})}),(0,r.jsxs)("div",{className:"flex min-w-0 flex-1 flex-col gap-3",children:[(0,r.jsx)("p",{className:"text-sm text-muted-foreground",children:s.description}),(0,r.jsx)("div",{className:"flex flex-col gap-3",children:s.parameters.filter(G).map(e=>{const n=(s.id==="dggs-grid"||s.id==="dggs-bin"||s.id==="dggs-compact")&&e.id==="resolution"?(()=>{const t=i.dggsType==="s2"||i.dggsType==="a5"||i.dggsType==="dggrid"||i.dggsType==="dggal"?i.dggsType:"h3",l=t==="dggal"?i.dggalType:i.dggridType,f=ve(t,typeof l=="string"?l:void 0);return{...e,max:f,label:d("processing.vectorTools.resolutionRange",{max:f})}})():e;return(0,r.jsx)(Ee,{param:n,value:i[e.id],layerOptions:Z(e.geometryFilter),fieldOptions:e.type==="field"?ee(e):void 0,onChange:t=>ne(e.id,t)},e.id)})}),s.supportsSidecar||s.requiresSidecar?(0,r.jsxs)("div",{className:"flex flex-col gap-1",children:[(0,r.jsxs)(ie,{className:"flex items-center gap-1.5 text-xs",children:[(0,r.jsx)(ye,{className:"h-3.5 w-3.5"})," ",d("processing.vectorTools.engine")]}),(0,r.jsxs)(ae,{value:x,onChange:e=>A(e.target.value),children:[(0,r.jsx)("option",{value:"client",disabled:s.requiresSidecar,children:d("processing.vectorTools.engineClient")}),(0,r.jsx)("option",{value:"sidecar",children:d("processing.vectorTools.engineSidecar")}),(0,r.jsx)("option",{value:"pyodide",children:d("processing.vectorTools.enginePyodide")})]}),x==="sidecar"&&I===null?(0,r.jsx)("p",{className:"text-xs text-muted-foreground",children:d("processing.vectorTools.checkingSidecar")}):null,x==="sidecar"&&I===!1?(0,r.jsx)("p",{className:"text-xs text-destructive",children:s.requiresSidecar?d("processing.vectorTools.sidecarUnavailablePyodide"):d("processing.vectorTools.sidecarUnavailableClient")}):null,x==="pyodide"?(0,r.jsx)("p",{className:"text-xs text-muted-foreground",children:d("processing.vectorTools.pyodideNote")}):null]}):null,(0,r.jsx)("div",{children:(0,r.jsxs)(se,{onClick:V,disabled:D||x==="sidecar"&&I!==!0,className:"gap-2",children:[D?(0,r.jsx)(ge,{className:"h-4 w-4 animate-spin"}):(0,r.jsx)(me,{className:"h-4 w-4"}),d("processing.vectorTools.run")]})}),(0,r.jsxs)(Q,{className:"h-24 rounded-md border bg-muted/30 p-2 font-mono text-xs",children:[P.length===0?(0,r.jsx)("span",{className:"text-muted-foreground",children:d("processing.vectorTools.outputPlaceholder")}):P.map((e,n)=>(0,r.jsx)("div",{className:"whitespace-pre-wrap",children:e},n)),(0,r.jsx)("div",{ref:W})]})]})]})]})})}export{Le as VectorToolsDialog};

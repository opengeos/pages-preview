import{Bs as x,Vs as y,_s as _,vs as A}from"./maplibre-b4Asg7jX.js";async function S(e){return new Promise(n=>{const t=new _({controller:!1,gl:e,parameters:{depthCompare:"less-equal"},width:null,height:null,onDeviceInitialized:r=>{n({deckInstance:t,device:r})}})})}async function C(e){const{deckInstance:n,device:t}=await S(e);let r,s,a;try{return r=t.createTexture({format:"rgba8unorm",width:1,height:1,sampler:{minFilter:"linear",magFilter:"linear",addressModeU:"clamp-to-edge",addressModeV:"clamp-to-edge"}}),s=new x(t,{vs:`#version 300 es
in vec2 pos;
out vec2 v_texcoord;
void main(void) {

...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function ud(){return new Bi({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ya(),fragmentShader:`
		...
		`,blending:Qi,depthTest:!1,depthWrite:!1})}function Ad(){return new Bi({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ya(),fragmentShader:`
	...
	`}var fd=class extends Ti{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;const i={width:e,height:e,depth:1},n=[i,i,i,i,i,i];this.texture=new zh(n),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;const i={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Xm={[Dc]:"Linear",[Lc]:"Reinhard",[Pc]:"Cineon",[Fc]:"ACESFilmic",[Nc]:"AgX",[Qc]:"Neutral",[Uc]:"Custom"};function Km(e,t){const i=Xm[t];return i===void 0?(ve("WebGLProgram: Unsupported toneMapping:",t),"vec3 "+e+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+e+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}var Ma=new B;function jm(){return Ve.getLuminanceCoefficients(Ma),["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${Ma.x.toFixed(4)}, ${Ma.y.toFixed(4)}, ${Ma.z.toFixed(4)} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+f);const b=_+g+a,C=_+f+o,S=Sd(s,s.VERTEX_SHADER,b),M=Sd(s,s.FRAGMENT_SHADER,C);s.attachShader(m,S),s.attachShader(m,M),i.index0AttributeName!==void 0?s.bindAttribLocation(m,0,i.index0AttributeName):i.morphTargets===!0&&s.bindAttribLocation(m,0,"position"),s.linkProgram(m);function T(w){if(e.debug.checkShaderErrors){const z=s.getProgramInfoLog(m)||"",F=s.getShaderInfoLog(S)||"",Q=s.getShaderInfoLog(M)||"",V=z.trim(),G=F.trim(),U=Q.trim();let j=!0,$=!0;if(s.getProgramParameter(m,s.LINK_STATUS)===!1)if(j=!1,typeof e.debug.onShaderError=="function")e.debug.onShaderError(s,m,S,M);else{const ie=Md(s,S,"vertex"),fe=Md(s,M,"fragment");we("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(m,s.VALIDATE_STATUS)+`

import{o as K}from"./rolldown-runtime-CEgmsyvS.js";import{t as re}from"./react-DIbmi2cZ.js";import{$ as oe,D as ie,O as ae,Q as se,_ as le,b as Q,g as de,h as ce,m as ue,v as pe}from"./context-DtXWZ0-W.js";import{t as fe}from"./jsx-runtime-BpnFPHy9.js";import{t as ge}from"./loader-circle-D67JJW2z.js";import{t as me}from"./play-6b5r3JZ8.js";import{t as ye}from"./server-C57jS9ah.js";import{t as he}from"./useTranslation-gp1fSphg.js";import{C as S}from"./src-8MJulTDS.js";import{B as _e}from"./src-Bo38V8Ps.js";import{$ as ve,Bt as Y,Ht as be,N as je,en as xe,zt as M}from"./src-D60MxII2.js";import{t as we}from"./processing-history-C6Da3cUc.js";import{t as ke}from"./pyodide-config-D2Ubn5xE.js";import{t as Se}from"./duckdb-processing-rVftQs63.js";import{t as Ee}from"./ParameterField-mFpnAskc.js";var Te=`# AUTO-GENERATED \u2014 do not edit. Source of truth:
...
def _estimate_metric_crs(gdf: Any) -> Any:
    ...
    When a layer crosses the antimeridian (longitude span > 180\xB0), standard
    UTM zone estimation calculates the centroid near 0\xB0 longitude (the wrong
    ...
    if (maxx - minx) > 180.0:
        raise ValueError(
            "Input layer crosses the antimeridian (longitude span > 180\xB0). "
...
`,Ae=12e4,Oe=3e5,E=null,Ne=0,b=new Map,L=new Set;function Pe(c){return L.add(c),()=>L.delete(c)}function Ie(c){for(const a of L)a(c)}function Ce(){return"./pyodide/pyodide-worker.js"}function Ge(){const c=ke(),a=new Worker(Ce()),m=new Promise((j,f)=>{let _,u=!1;const w=g=>{if(!u){u=!0,_&&clearTimeout(_),a.terminate(),E=null;for(const[d,h]of b)b.delete(d),h.reject(new Error(g))}};_=setTimeout(()=>{const g="Timed out loading the Python runtime. Check your connection and try again.";w(g),f(new Error(g))},Ae),a.onmessage=g=>{const d=g.data??{};switch(d.type){case"progress":Ie(d.phase);break;case"ready":_&&clearTimeout(_),j();break;case"result":{const h=b.get(d.id);h&&(b.delete(d.id),h.resolve({geojson:d.geojson,messages:d.messages}));break}case"error":{const h=d.message||"Pyodide error";if(d.id===void 0)w(h),f(new Error(h));else{const i=b.get(d.id);i&&(b.delete(d.id),i.reject(new Error(h)))}break}}},a.onerror=g=>{const d=g.message||"Pyodide worker failed";w(d),f(new Error(d))}});return a.postMessage({type:"init",indexURL:c,vectorOpsSource:Te}),m.then(()=>({worker:a}))}function Re(){return E??=Ge().catch(c=>{throw E=null,c}),E}async function Ve(c){const{worker:a}=await Re(),m=Ne++;return new Promise((j,f)=>{const _=setTimeout(()=>{if(b.has(m)){b.delete(m),a.terminate(),E=null;for(const[u,w]of b)b.delete(u),w.reject(new Error("Pyodide worker was reset after a timeout."));f(new Error("The Python (Pyodide) operation timed out."))}},Oe);b.set(m,{resolve:u=>{clearTimeout(_),j(u)},reject:u=>{clearTimeout(_),f(u)}}),a.postMessage({type:"run",id:m,request:c})})}var o=K(re(),1),r=K(fe(),1);function Me(){const c=[];for(const a of M){const m=a.group??"Tools";let j=c.find(f=>f.group===m);j||(j={group:m,tools:[]},c.push(j)),j.tools.push(a)}return c}function Le({mapControllerRef:c}){const{t:a}=he(),m=S(e=>e.ui.vectorToolOpen),j=S(e=>e.setVectorToolOpen),f=S(e=>e.layers),_=S(e=>e.addGeoJsonLayer),u=S(e=>e.ui.processingRerun),w=S(e=>e.setProcessingRerun),g=m!==null,[d,h]=(0,o.useState)(m??M[0].id),[i,T]=(0,o.useState)({}),[k,A]=(0,o.useState)("client"),[P,O]=(0,o.useState)([]),[D,q]=(0,o.useState)(!1),[I,F]=(0,o.useState)(null),[U,J]=(0,o.useState)(!1),W=(0,o.useRef)(null),B=(0,o.useRef)(null),s=(0,o.useMemo)(()=>Y(d)??M[0],[d]),H=(0,o.useMemo)(()=>Se(),[]);(0,o.useEffect)(()=>{m&&h(m)},[m]),(0,o.useEffect)(()=>{const e={};for(const n of s.parameters)n.default!==void 0&&(e[n.id]=n.default);T(e),O([]),s.requiresSidecar?A("sidecar"):s.supportsSidecar||A("client")},[s]),(0,o.useEffect)(()=>{if(!g||!u||u.kind!=="vector")return;const e=be(u.toolId,u.parameters);if(!Y(e.toolId)){O(n=>[...n,`Error: ${a("processing.history.toolUnavailable",{toolId:u.toolId})}`]),w(null);return}if(e.toolId!==s.id){d!==e.toolId&&h(e.toolId);return}T({...e.parameters}),(u.engine==="client"||u.engine==="sidecar"||u.engine==="pyodide")&&A((u.engine,u.engine)),w(null),u.autoRun&&J(!0)},[g,u,s,d,w,a]),(0,o.useEffect)(()=>{if(d!=="dggs-grid"||i.source!=="bbox"||i.west!==void 0||i.south!==void 0||i.east!==void 0||i.north!==void 0)return;const e=c.current?.getMap();if(!e)return;const n=e.getBounds(),t=l=>Number(l.toFixed(6));T(l=>({...l,west:t(n.getWest()),south:t(n.getSouth()),east:t(n.getEast()),north:t(n.getNorth())}))},[d,i.source,c]),(0,o.useEffect)(()=>{if(!g)return;let e=!1;return je().then(n=>{e||F(n.available)}).catch(()=>{e||F(!1)}),()=>{e=!0}},[g]),(0,o.useEffect)(()=>{W.current?.scrollIntoView({block:"end"})},[P]);const C=(0,o.useRef)(null),y=(0,o.useCallback)(e=>{e.startsWith("Error:")&&(C.current=e.slice(6).trim()),O(n=>[...n,e])},[]),Z=(0,o.useCallback)(e=>f.filter(n=>{if(n.type!=="geojson"||!n.geojson)return!1;if(!e?.length)return!0;const t=_e(n.geojson);return e.some(l=>l==="point"&&t.hasPoint||l==="line"&&t.hasLine||l==="polygon"&&t.hasPolygon)}),[f]),z=(0,o.useMemo)(()=>{const n=new Map;if(!g)return n;for(const t of f){if(t.type!=="geojson"||!t.geojson)continue;const l=new Set;for(const p of t.geojson.features.slice(0,1e3))for(const x of Object.keys(p.properties??{}))l.add(x);n.set(t.id,[...l])}return n},[f,g]),ee=(0,o.useCallback)(e=>{const n=i[e.fieldSource??"layer"];return n&&z.get(n)||[]},[z,i]),ne=(0,o.useCallback)((e,n)=>{T(t=>{const l={...t,[e]:n};for(const p of s.parameters)p.type==="field"&&(p.fieldSource??"layer")===e&&(l[p.id]=void 0);return l})},[s]),G=(0,o.useCallback)(e=>{const n=e.visibleWhen;if(!n)return!0;const t=i[n.param];return"in"in n?t!=null&&n.in.includes(t):t==null||!n.notIn.includes(t)},[i]),N=(0,o.useCallback)((e,n)=>{if(!n.features.length){y(`No features produced for "${e}"`);return}const t=_(e,n);B.current?.addOutputLayer(e);const l=S.getState().layers.find(p=>p.id===t);l&&c.current?.fitLayer(l)},[_,y,c]),R=(0,o.useCallback)(async(e,n)=>{const t=f.find(v=>v.id===i.layer),l=f.find(v=>v.id===i.overlay);if(!t?.geojson){const v="input layer no longer exists in the project";return y(`Error: ${v}`),v}if(i.overlay&&!l?.geojson){const v="overlay layer no longer exists in the project";return y(`Error: ${v}`),v}y(`Running "${s.name}" ${e}...`);const p=await n({tool_id:s.id,geojson:t.geojson,overlay:l?.geojson,parameters:i});for(const v of p.messages)y(v);const x=p.geojson;if(x?.type==="FeatureCollection"&&Array.isArray(x.features))return N(s.name,x),null;const X="engine returned invalid GeoJSON";return y(`Error: ${X}`),X},[f,i,s,y,N]),V=(0,o.useCallback)(async()=>{O([]),C.current=null;for(const n of s.parameters){if(!n.required||!G(n))continue;const t=i[n.id];if(t===void 0||t===""||t===null||n.type==="number"&&Number.isNaN(t)){y(`Error: "${n.label}" is required`);return}}const e=we({kind:"vector",toolId:s.id,toolName:s.name,engine:k,parameters:i});B.current=e,q(!0);try{let n=null;if(k==="sidecar")n=await R("on the Python sidecar",ve);else if(k==="pyodide"){const l=Pe(p=>y(`${p}...`));try{n=await R("in your browser (Pyodide)",Ve)}finally{l()}}else{const l={layers:f,parameters:i,log:y,fitBounds:p=>c.current?.fitBounds(p),addResultLayer:N,duckdb:H,viewportBounds:()=>{const p=c.current?.getMap();if(!p)return null;const x=p.getBounds();return[x.getWest(),x.getSouth(),x.getEast(),x.getNorth()]}};await s.run(l)}const t=n??C.current;t?e.finish("error",t):e.finish("success")}catch(n){y(`Error: ${n.message}`),e.finish("error",n.message)}finally{q(!1)}},[s,i,k,f,y,N,R,c,G,H]),$=(0,o.useRef)(V);(0,o.useEffect)(()=>{$.current=V}),(0,o.useEffect)(()=>{U&&(J(!1),$.current())},[U]);const te=(0,o.useMemo)(Me,[]);return(0,r.jsx)(ue,{open:g,onOpenChange:e=>{e||j(null)},children:(0,r.jsxs)(ce,{className:"max-w-3xl",children:[(0,r.jsxs)(le,{children:[(0,r.jsx)(pe,{children:a("processing.vectorTools.title")}),(0,r.jsx)(de,{children:a("processing.vectorTools.description")})]}),(0,r.jsxs)("div",{className:"flex gap-4",children:[(0,r.jsx)(Q,{className:"h-[22rem] w-48 shrink-0 rounded-md border",children:(0,r.jsx)("div",{className:"p-1",children:te.map(e=>(0,r.jsxs)("div",{className:"mb-1",children:[(0,r.jsx)("div",{className:"px-2 py-1 text-xs font-medium text-muted-foreground",children:e.group}),e.tools.map(n=>(0,r.jsx)("button",{type:"button",onClick:()=>h(n.id),className:oe("w-full rounded-md px-2 py-1.5 text-start text-sm transition-colors hover:bg-accent",n.id===d&&"bg-accent font-medium text-accent-foreground"),children:n.name},n.id))]},e.group))})}),(0,r.jsxs)("div",{className:"flex min-w-0 flex-1 flex-col gap-3",children:[(0,r.jsx)("p",{className:"text-sm text-muted-foreground",children:s.description}),(0,r.jsx)("div",{className:"flex flex-col gap-3",children:s.parameters.filter(G).map(e=>{const n=(s.id==="dggs-grid"||s.id==="dggs-bin"||s.id==="dggs-compact")&&e.id==="resolution"?(()=>{const t=i.dggsType==="s2"||i.dggsType==="a5"||i.dggsType==="dggrid"||i.dggsType==="dggal"?i.dggsType:"h3",l=t==="dggal"?i.dggalType:i.dggridType,p=xe(t,typeof l=="string"?l:void 0);return{...e,max:p,label:a("processing.vectorTools.resolutionRange",{max:p})}})():e;return(0,r.jsx)(Ee,{param:n,value:i[e.id],layerOptions:Z(e.geometryFilter),fieldOptions:e.type==="field"?ee(e):void 0,onChange:t=>ne(e.id,t)},e.id)})}),s.supportsSidecar||s.requiresSidecar?(0,r.jsxs)("div",{className:"flex flex-col gap-1",children:[(0,r.jsxs)(ie,{className:"flex items-center gap-1.5 text-xs",children:[(0,r.jsx)(ye,{className:"h-3.5 w-3.5"})," ",a("processing.vectorTools.engine")]}),(0,r.jsxs)(ae,{value:k,onChange:e=>A(e.target.value),children:[(0,r.jsx)("option",{value:"client",disabled:s.requiresSidecar,children:a("processing.vectorTools.engineClient")}),(0,r.jsx)("option",{value:"sidecar",children:a("processing.vectorTools.engineSidecar")}),(0,r.jsx)("option",{value:"pyodide",children:a("processing.vectorTools.enginePyodide")})]}),k==="sidecar"&&I===null?(0,r.jsx)("p",{className:"text-xs text-muted-foreground",children:a("processing.vectorTools.checkingSidecar")}):null,k==="sidecar"&&I===!1?(0,r.jsx)("p",{className:"text-xs text-destructive",children:s.requiresSidecar?a("processing.vectorTools.sidecarUnavailablePyodide"):a("processing.vectorTools.sidecarUnavailableClient")}):null,k==="pyodide"?(0,r.jsx)("p",{className:"text-xs text-muted-foreground",children:a("processing.vectorTools.pyodideNote")}):null]}):null,(0,r.jsx)("div",{children:(0,r.jsxs)(se,{onClick:V,disabled:D||k==="sidecar"&&I!==!0,className:"gap-2",children:[D?(0,r.jsx)(ge,{className:"h-4 w-4 animate-spin"}):(0,r.jsx)(me,{className:"h-4 w-4"}),a("processing.vectorTools.run")]})}),(0,r.jsxs)(Q,{className:"h-24 rounded-md border bg-muted/30 p-2 font-mono text-xs",children:[P.length===0?(0,r.jsx)("span",{className:"text-muted-foreground",children:a("processing.vectorTools.outputPlaceholder")}):P.map((e,n)=>(0,r.jsx)("div",{className:"whitespace-pre-wrap",children:e},n)),(0,r.jsx)("div",{ref:W})]})]})]})]})})}export{Le as VectorToolsDialog};

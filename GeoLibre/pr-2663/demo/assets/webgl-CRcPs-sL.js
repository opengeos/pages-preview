...
`,Ee=({inputs:t,output:e,target:r})=>(v({module:{name:"row_length",vs:xe},inputs:t,output:e,operationType:"float32",outputBuffer:r}),{success:!0}),ye=async({inputs:t,output:e,target:r})=>{const{segments:n}=t,i=r.device,u=b("result",e.type,e.size),o=n.type,s=Y(n,o,i),a=new T(i,{vs:`#version 300 es

...
async function __wbg_init(module_or_path) {
	...
	if (module_or_path === void 0) module_or_path = new URL("" + new URL("geolibre_wasm_bg-Dx17h41C.wasm", import.meta.url).href, "" + import.meta.url);
...
async function initTools(source) {
	...
	if (!source) source = new URL("" + new URL("geolibre-cli-DwxZoaM-.wasm", import.meta.url).href, "" + import.meta.url);

var l={name:"black-is-zero",inject:{"fs:#decl":`
  vec3 black_zero_to_rgb(float value) {
    return vec3(value, value, value);
  }
`,"fs:DECKGL_FILTER_COLOR":`
      color.rgb = black_zero_to_rgb(color.r);
    `}},a="colormap",t={name:a,fs:`uniform ${a}Uniforms {
  int colormapIndex;
  float reversed;
} ${a};
...
`,"fs:DECKGL_FILTER_COLOR":`
    ...
    `},uniformTypes:{colormapIndex:"i32",reversed:"f32"},getUniforms:e=>({colormapTexture:e.colormapTexture,colormapIndex:e.colormapIndex??0,reversed:e.reversed??!1})},s={name:"create-texture-unorm",inject:{"fs:#decl":"uniform sampler2D textureName;","fs:DECKGL_FILTER_COLOR":`
      color = texture(textureName, geometry.uv);
    `},getUniforms:e=>({textureName:e.textureName})},o="nodata",c={name:o,fs:`uniform ${o}Uniforms {
  float value;
} ${o};
